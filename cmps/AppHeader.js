export default {
    template: `
        <header class="app-header">
            <nav >
                <div class="logo">
                <router-link to="/"><img class="logo-head" src="../img/logo.jpeg"></router-link>
                </div>
           ...
           <div class="logos-container">
             ...
             <router-link @click="isShown=!isShown" to="/book"><img class="logo-btn" src="../img/books.logo.png"></router-link>
